...
const NavBar = () => {
	...
	return (
		<header className="absolute inset-x-0 top-0 z-50">
			<nav aria-label="Global" className="flex items-center justify-between px-0 py-6 lg:px-0 lg:py-8">
				{/* LOGO --------------------------------------------------------------- */}
				...
				<div className="hidden lg:flex lg:flex-1 lg:justify-end">
					<Button className="lg:!w-54 lg:!h-11 lg:!text-base">Transformar mi marca</Button>
				</div>
			</nav>
